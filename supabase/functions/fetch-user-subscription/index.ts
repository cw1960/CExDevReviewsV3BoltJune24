  ...
  try {
    ...
    if (subscriptionError) {
      ...
      if (subscriptionError.code === 'PGRST116') {
        console.log('ℹ️ No subscription found for user - this is normal for free tier users')
        return new Response(
          JSON.stringify({ 
            success: true,
            data: null,
    ...
    console.log('✅ Subscription data fetched successfully:', subscriptionData ? 'subscription found' : 'no subscription')
    ...
    return new Response(
      JSON.stringify({ 
        success: false, 
        error: 'Internal server error occurred while fetching subscription data',
