...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(
      "✅ Review assignments fetched successfully:",
    ...
    console.log(
      "✅ Extension details fetched successfully:",
      extensions?.length || 0,
      "extensions",
    );
    ...
    const assignmentsWithDetails: ReviewAssignmentWithDetails[] =
    ...
    console.error(
      "💥 Error in fetch-review-assignments-for-reviewer function:",
      {
    ...
    return new Response(
      JSON.stringify({
        success: false,
        error:
          "Internal server error occurred while fetching review assignments",
