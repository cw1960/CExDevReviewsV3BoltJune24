  ...
  try {
    ...
    try {
      ...
      const messageData = {
        ...
        is_read: false,
        sender_id: "3fdda06e-a61b-493a-9d8f-282535d5c0f8",
      };
      console.log(
      ...
      console.log(
        "💾 Attempting to insert message into user_messages table...",
      );
      ...
      console.log(
        "💥 Error creating Supabase client or database operation:",
