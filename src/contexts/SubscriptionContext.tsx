      ...
      try {
        ...
        if (purchaseResult.customerInfo.entitlements.active["premium"]) {
          notifications.show({
            ...
            message:
              "Welcome to Review Fast Track! Your account has been upgraded.",
            color: "green",
          });
          ...
          notifications.show({
            ...
            message:
              "Your purchase was processed but premium access is not yet active. Please contact support if this persists.",
            color: "orange",
          });
          return false;
        }
    ...
    try {
      ...
      if (customerInfo.entitlements.active["premium"]) {
        notifications.show({
          ...
          message:
            "Your Review Fast Track subscription has been restored successfully.",
          color: "green",
        });
        ...
        notifications.show({
          ...
          message:
            "No active Review Fast Track subscriptions were found to restore.",
          color: "blue",
        });
        return false;
      }
