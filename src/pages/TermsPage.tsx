        ...
        <Stack gap="xl">
          ...
          <Stack gap="lg">
            ...
            <div>
              ...
              <Text lh={1.6}>
                Welcome to ChromeExDev.Reviews. These Terms and Conditions
                ("Terms") govern your access to and use of the
                ChromeExDev.Reviews website (the "Service"). The Service is
                owned and operated by El Barrial Devs ("we," "us," or "our"), a
                company located in Monterrey, Mexico.
              </Text>
              <Text lh={1.6} mt="md">
            ...
            <div>
              ...
              <List spacing="sm">
                <List.Item>
                  <strong>Service:</strong> The ChromeExDev.Reviews website
                </List.Item>
                <List.Item>
                ...
                <List.Item>
                  <strong>Content:</strong> Any information, data, text,
                  software, graphics, or other materials displayed or available
                  through the Service
                </List.Item>
              </List>
            </div>
            ...
            <div>
              ...
              <List spacing="xs" size="sm">
                ...
                <List.Item>
                  Use the Service to send, knowingly receive, upload, download,
                  or use any material that is unlawful, harmful, threatening,
                ...
                <List.Item>
                  Use the Service for any commercial purposes without our prior
                  written consent
                </List.Item>
                <List.Item>
            ...
            <div>
              ...
              <Text lh={1.6} mb="md">
                ...
                functionality are and will remain the exclusive property of El
                Barrial Devs and its licensors. The Service is protected by
                copyright, trademark, and other laws of both Mexico and foreign
                countries. Our trademarks and trade dress may not be used in
                connection with any product or service without the prior written
                consent of El Barrial Devs.
              </Text>
              ...
              <Text lh={1.6}>
                ...
                responsible for protecting those rights. By uploading or sharing
                content through the Service, you grant us a worldwide,
            ...
            <div>
              ...
              <Text lh={1.6}>
                ...
                services that are not owned or controlled by El Barrial Devs. We
            ...
            <div>
              ...
              <Text lh={1.6} mb="sm">
                In no event shall El Barrial Devs, its directors, employees,
            ...
            <div>
              ...
              <Text lh={1.6} mb="sm">
                ...
                performance. El Barrial Devs, its subsidiaries, affiliates, and
            ...
            <div>
              ...
              <Text lh={1.6}>
                ...
                the laws of Mexico, without regard to its conflict of law
            ...
            <div>
              ...
              <Text lh={1.6}>
                ...
                accordance with the laws of Mexico. The arbitration shall take
                place in Monterrey, Mexico.
              </Text>
            </div>
            ...
            <div>
              ...
              <List spacing="xs" size="sm">
                <List.Item>
                  <strong>Email:</strong> cristo@cristolopez.com
                </List.Item>
                <List.Item>
                  <strong>Address:</strong> El Barrial Devs, Monterrey, Mexico
                </List.Item>
              </List>
            </div>
            ...
            <Box bg="blue.0" p="lg" style={{ borderRadius: "8px" }}>
              <Text fw={600} ta="center" lh={1.6}>
                By using the ChromeExDev.Reviews website you acknowledge that
