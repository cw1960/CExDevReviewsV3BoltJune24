        ...
        <Stack gap="xl">
          ...
          <Stack gap="lg">
            ...
            <div>
              ...
              <Text lh={1.6}>
                Welcome to ChromeExDev.Reviews. This Privacy Policy explains how
                El Barrial Devs ("we," "us," or "our"), located in Monterrey,
                Mexico, collects, uses, discloses, and safeguards your
                information when you visit our website and use our application
                ChromeExDev.Reviews (the "Service").
              </Text>
              <Text lh={1.6} mt="md">
            ...
            <div>
              ...
              <Text lh={1.6}>
                ...
                activities. You can control cookie settings through your browser
                preferences, though disabling cookies may limit some
            ...
            <div>
              ...
              <Text lh={1.6} mb="md">
                ...
                information may be transferred to the new entity, subject to the
            ...
            <div>
              ...
              <List spacing="xs" size="sm" mb="md">
                <List.Item>
                  <strong>El Barrial Devs</strong>
                </List.Item>
                <List.Item>
                  <strong>Email:</strong> cristo@cristolopez.com
                </List.Item>
                <List.Item>
                  <strong>Address:</strong> Monterrey, Mexico
                </List.Item>
              </List>
              <Text lh={1.6}>
                For data protection inquiries, please include "Privacy Policy"
            ...
            <div>
              ...
              <Text lh={1.6}>
                This Privacy Policy is governed by the laws of Mexico. Any
                disputes arising from this Privacy Policy will be resolved in
            ...
            <Box bg="blue.0" p="lg" style={{ borderRadius: "8px" }}>
              <Text fw={600} ta="center" lh={1.6}>
                By using ChromeExDev.Reviews, you acknowledge that you have
