...
export function LandingPage() {
  ...
  const handleCookieAccept = async () => {
    console.log("🍪 handleCookieAccept called");
    try {
      console.log("🍪 Attempting to update cookie preferences...");
      console.log(
        "🍪 Current profile state:",
        profile ? "profile exists" : "no profile",
      );
      if (profile) {
        console.log("🍪 Profile exists, updating database...");
        // For authenticated users, update in database
        await updateCookiePreferences("accepted");
      } else {
        console.log("🍪 No profile, updating localStorage...");
      ...
      console.log("🍪 Setting showCookieModal to false (after success)");
      setShowCookieModal(false);
    } catch (error) {
      console.error("🍪 Error in handleCookieAccept:", error);
      console.error("Error updating cookie preferences:", error);
      // Still close the modal even if there's an error
      console.log("🍪 Setting showCookieModal to false (after error)");
      setShowCookieModal(false);
    }
  };

  const handleCookieDecline = async () => {
    console.log("🍪 handleCookieDecline called");
    try {
      console.log("🍪 Attempting to decline cookie preferences...");
      if (profile) {
        console.log("🍪 Profile exists, updating database with declined...");
        // For authenticated users, update in database
        await updateCookiePreferences("declined");
      } else {
        console.log("🍪 No profile, updating localStorage with declined...");
        // For non-authenticated users, store in localStorage
        localStorage.setItem("cookie_consent_shown", "true");
        localStorage.setItem("cookie_preference", "declined");
      }
      console.log("🍪 Setting showCookieModal to false (decline success)");
      setShowCookieModal(false);
    } catch (error) {
      console.error("🍪 Error in handleCookieDecline:", error);
      console.error("Error updating cookie preferences:", error);
      // Still close the modal even if there's an error
      console.log("🍪 Setting showCookieModal to false (decline error)");
      setShowCookieModal(false);
    }
  };
  ...
  const testimonials = [
    {
      ...
      content:
        "Went from 3 reviews to 47 reviews in just 2 weeks. My extension finally started showing up in search results and organic installs increased by 340%.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "The quality of reviews is incredible. These are developers who actually understand extensions, not random users. Got detailed feedback that helped improve my product too.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "Finally broke through the visibility barrier. My extension went from page 8 to page 1 in search results. The algorithm really does reward consistent review activity.",
      rating: 5,
      ...
      <Box bg="linear-gradient(135deg, #667eea 0%, #764ba2 100%)">
        <Container size="lg">
          ...
          <Group justify="space-between" mb="xl">
            ...
            />
            <Group>
              <Button variant="subtle" color="blue" onClick={handleLogin}>
                Login
              </Button>
            </Group>
          </Group>
          ...
          <Grid align="center">
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Stack gap="xl">
                ...
                >
                  Break the Zero-Review Trap! Get Steady Chrome Extension
                  Installs, Ratings and Reviews in Days Instead of Months
                </Title>
                <Title
                  order={2}
                  size="1.5rem"
                  ...
                  lh={1.4}
                >
                  Stop watching your extension collect dust. Get quality reviews
                  from fellow developers who actually understand Chrome
                  extensions.
                </Title>
                <Button
                  size="xl"
                  ...
                  <Stack align="center" gap="md">
                    ...
                    >
                      <iframe
                        width="100%"
                        height="100%"
                        src="https://www.youtube.com/embed/g66LsZyEdLk"
                        title="ChromeExDev Demo - Get 20+ Reviews in Your First Month"
                        frameBorder="0"
                    ...
                    <Text c="rgba(255,255,255,0.8)" size="sm" ta="center">
                      See how developers are getting 20+ reviews in their first
                      month
                    </Text>
                  </Stack>
                </Box>
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Stack gap="lg">
                ...
                <Text size="lg" c="dimmed" lh={1.6}>
                  Instead of being buried on page 10 of search results with zero
                  downloads... You'll get steady visibility as your review count
                  and ratings climb, pushing your extension higher in Chrome Web
                  Store rankings every week with Review Fast Track.
                </Text>
                <Text
                  size="md"
                  c="blue.6"
                ...
                >
                  "Watch your extension move from invisible to discoverable as
                  authentic reviews from fellow developers signal quality to
                  Google's algorithm."
                </Text>
              </Stack>
            </Grid.Col>
              ...
              <Card shadow="lg" radius="lg" p="xl" bg="blue.0">
                <Stack align="center" gap="md">
                  ...
                  <Text
                    size="3rem"
                    fw={800}
                    className="landing-card-number-blue"
                  >
                    8.3x
                  </Text>
          ...
          <Grid align="center">
            ...
            <Grid.Col span={{ base: 12, md: 6 }} order={{ base: 1, md: 2 }}>
              <Stack gap="lg">
                ...
                <Text size="lg" c="dimmed" lh={1.6}>
                  Instead of waiting months for users to maybe leave a review
                  (if you're lucky)... You'll get a consistent stream of
                  detailed, helpful reviews from developers who actually
                  understand and use Chrome extensions with Review Fast Track.
                </Text>
                <Text
                  size="md"
                  c="green.6"
                  ...
                  style={{ fontStyle: "italic" }}
                >
                  "Finally get those crucial first 10-50 reviews that make new
                  users trust your extension enough to install it."
                </Text>
              </Stack>
            </Grid.Col>
          </Grid>
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Stack gap="lg">
                ...
                <Text
                  ...
                  style={{ fontStyle: "italic" }}
                >
                  "Level the playing field with extensions that have been around
                  for years - quality and recent activity matter more than age."
                </Text>
              </Stack>
            </Grid.Col>
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Card shadow="lg" radius="lg" p="xl" bg="purple.0">
                <Stack align="center" gap="md">
                  ...
                  <Text
                    size="3rem"
                    fw={800}
                    className="landing-card-number-purple"
                  >
                    89%
                  </Text>
                  <Text size="sm" c="dimmed" ta="center">
          ...
          <Grid align="center">
              ...
              <Card shadow="lg" radius="lg" p="xl" bg="orange.0">
                <Stack align="center" gap="md">
                  ...
                  <Text
                    size="3rem"
                    fw={800}
                    className="landing-card-number-orange"
                  >
                    15h
                  </Text>
                  <Text size="sm" c="dimmed" ta="center">
            ...
            <Grid.Col span={{ base: 12, md: 6 }} order={{ base: 1, md: 2 }}>
              <Stack gap="lg">
                ...
                <Text size="lg" c="dimmed" lh={1.6}>
                  Instead of spending hours hunting down developers to beg for
                  reviews (and risking policy violations)... You'll get
                  automatic connections with motivated reviewers through our
                  compliant algorithm - no awkward asks, no policy risks.
                </Text>
                <Text
                  size="md"
                  c="orange.6"
                  ...
                  style={{ fontStyle: "italic" }}
                >
                  "Focus on building great extensions while we handle getting
                  them discovered safely and efficiently."
                </Text>
              </Stack>
            </Grid.Col>
          </Grid>
            ...
            <Grid.Col span={{ base: 12, md: 6 }}>
              <Stack gap="lg">
                ...
                <Text
                  ...
                  style={{ fontStyle: "italic" }}
                >
                  "Create the upward spiral successful extensions need: steady
                  reviews → better rankings → more organic discovery → sustained
                  growth."
                </Text>
                <Button
                  size="lg"
              ...
              <Card shadow="lg" radius="lg" p="xl" bg="red.0">
                <Stack align="center" gap="md">
                  ...
                  <Text
                    size="3rem"
                    fw={800}
                    className="landing-card-number-red"
                  >
                    340%
                  </Text>
                  <Text size="sm" c="dimmed" ta="center">
        ...
        <Stack gap={80}>
          ...
          <Stack align="center" gap="md">
            ...
            <Text
              ...
              style={{ fontStyle: "italic" }}
            >
              Simple, compliant, and effective - get quality reviews from
              developers who actually understand extensions
            </Text>
          </Stack>
                ...
                <Card shadow="lg" radius="lg" p="xl" h="100%">
                  <Stack align="center" gap="lg">
                    ...
                    <Text ta="center" c="dimmed" lh={1.6}>
                      <strong>Sign up free</strong> and add your Chrome
                      extension to our developer network. Connect with a
                      community of extension developers who understand the
                      challenges you face.
                    </Text>
                  </Stack>
                </Card>
              ...
              <Grid.Col span={{ base: 12, md: 4 }}>
                <Card shadow="lg" radius="lg" p="xl" h="100%">
                  <Stack align="center" gap="lg">
                    ...
                    <Text ta="center" c="dimmed" lh={1.6}>
                      <strong>Review to earn credits.</strong> Write thoughtful
                      reviews for other developers' extensions to earn credits.
                      Each quality review earns you a credit to get your own
                      extension reviewed.
                    </Text>
                  </Stack>
                </Card>
              ...
              <Grid.Col span={{ base: 12, md: 4 }}>
                <Card shadow="lg" radius="lg" p="xl" h="100%">
                  <Stack align="center" gap="lg">
                    ...
                    <Text ta="center" c="dimmed" lh={1.6}>
                      <strong>Watch your reviews grow.</strong> Our algorithm
                      matches your extension with qualified reviewers who
                      actually install, test, and provide detailed feedback.
                    </Text>
                  </Stack>
                </Card>
              </Grid.Col>
                  ...
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="sm" flex={1}>
                      ...
                      <Text size="sm" c="dimmed" lh={1.5}>
                        <strong>No direct 1-for-1 exchanges.</strong> Our smart
                        algorithm prevents the direct trading patterns that
                        Google prohibits. You review extensions, earn credits,
                        then use credits to get reviewed - creating a compliant
                        community ecosystem.
                      </Text>
                    </Stack>
                  </Group>
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                <Card withBorder p="xl" h="100%">
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="sm" flex={1}>
                      <Title order={4} size="1.1rem">
                        Reviews from Real Developers
                      </Title>
                      <Text size="sm" c="dimmed" lh={1.5}>
                        <strong>Quality over quantity.</strong> Every reviewer
                        is a Chrome extension developer who understands the
                        ecosystem. No random users, no fake accounts - just
                ...
                <Card withBorder p="xl" h="100%">
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="sm" flex={1}>
                      ...
                      <Text size="sm" c="dimmed" lh={1.5}>
                        <strong>
                          Consistent review activity signals quality to Google's
                          ranking algorithm.
                        </strong>{" "}
                        Regular, authentic reviews help your extension climb
                        search results and attract organic users.
                      </Text>
                    </Stack>
                  </Group>
                </Card>
                ...
                <Card withBorder p="xl" h="100%">
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="sm" flex={1}>
                      ...
                      <Text size="sm" c="dimmed" lh={1.5}>
                        <strong>Start immediately with no risk.</strong> Test
                        the platform, see the quality of reviews, and experience
                        the growth before deciding if you want to upgrade.
                      </Text>
                    </Stack>
                  </Group>
                </Card>
                  ...
                  <Stack gap="lg">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <List.Item>
                          <strong>Credit-based system</strong> (review others to
                          earn credits)
                        </List.Item>
                        <List.Item>
                          <strong>Full platform access</strong> to test quality
                        </List.Item>
                      </List>
                    </div>
                ...
                >
                  ...
                  <Stack gap="lg">
                    ...
                    <div>
                      ...
                      >
                        <List.Item>
                          <strong>Unlimited extensions</strong> in your
                          portfolio
                        </List.Item>
                        <List.Item>
                          <strong>Unlimited reviews per month</strong>
                        </List.Item>
                        <List.Item>
                          <strong>Priority queue processing</strong> (under 24
                          hours)
                        </List.Item>
                        <List.Item>
                    ...
                    <Card withBorder p="md" bg="rgba(255,255,255,0.1)">
                      ...
                      <Text size="sm" c="rgba(255,255,255,0.9)" lh={1.4}>
                        While free users wait 1-2 days in the standard queue,
                        Review Fast Track members skip to the front and usually
                        get reviewed in under 12 hours, often MUCH faster.
                      </Text>
                    </Card>
                  ...
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="xs" flex={1}>
                      ...
                      <Text size="sm" c="dimmed">
                        Try Review Fast Track risk-free. If you're not satisfied
                        with the speed and quality, we'll refund your first
                ...
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <Group gap="md" align="flex-start">
                    ...
                    <Stack gap="xs" flex={1}>
                      ...
                      <Text size="sm" c="dimmed">
                        No contracts, no commitments. Upgrade or downgrade
                        anytime. Your free tier access remains forever.
                      </Text>
                    </Stack>
                  </Group>
                </Grid.Col>
            ...
            <Card withBorder p="xl">
              <Stack gap="lg">
                <div>
                  ...
                  >
                    <List.Item>
                      <strong>Sign up free</strong> - No credit card required
                    </List.Item>
                    <List.Item>
                ...
                <div>
                  ...
                  <Text
                    ...
                    style={{ fontStyle: "italic" }}
                  >
                    Join a fast growing community of extension developers who
                    refuse to let great extensions stay invisible
                  </Text>
                </div>
              </Stack>
            </Card>
          ...
          <Stack gap="xl" align="center">
            <Stack gap="md" align="center">
              ...
              <Text size="lg" c="dimmed" ta="center" maw={600}>
                See how Chrome extension developers are breaking through the
                visibility barrier and growing their user base
              </Text>
            </Stack>
            <Grid>
          ...
          <Stack align="center" gap="xl">
            <Stack align="center" gap="md">
              ...
              <Text size="lg" c="rgba(255,255,255,0.9)" ta="center" maw={500}>
                Join a fast growing community of Chrome extension developers who
                are getting steady reviews and growing their user base every
                week.
              </Text>
            </Stack>
            <Button
        ...
        <Container size="lg">
          <Stack align="center" gap="md">
            ...
            <Text size="sm" c="gray.5" ta="center">
              © 2025 El Barrial Devs | ChromeExDev.Reviews. All rights
              reserved. Not associated with or endorsed by Google, Chrome Web
              Store, or Alphabet.
            </Text>
          </Stack>
        </Container>
